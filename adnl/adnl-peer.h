...
class AdnlPeerPair : public td::actor::Actor {
 public:
  ...
  virtual void get_stats(bool all, td::Promise<tl_object_ptr<ion_api::adnl_stats_peerPair>> promise) = 0;
...
class AdnlPeer : public td::actor::Actor {
 public:
  ...
  virtual void get_stats(bool all, td::Promise<std::vector<tl_object_ptr<ion_api::adnl_stats_peerPair>>> promise) = 0;
};
