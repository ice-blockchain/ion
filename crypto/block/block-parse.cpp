...
const Aug_InMsgDescr aug_InMsgDescrDefault(ion::SUPPORTED_VERSION);
const InMsgDescr t_InMsgDescrDefault(ion::SUPPORTED_VERSION);
...
const Aug_OutMsgDescr aug_OutMsgDescrDefault(ion::SUPPORTED_VERSION);
const OutMsgDescr t_OutMsgDescrDefault(ion::SUPPORTED_VERSION);
