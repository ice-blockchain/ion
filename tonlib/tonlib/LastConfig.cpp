...
void LastConfig::on_config(td::Result<ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo>> r_config) {
...
td::Status LastConfig::process_config(
    td::Result<ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo>> r_config) {
...
td::Status LastConfig::process_config_proof(ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo> raw_config) {
