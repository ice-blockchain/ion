...
AdnlMessage::AdnlMessage(tl_object_ptr<ion_api::adnl_Message> message) {
  ion_api::downcast_call(
      *message.get(),
      td::overloaded(
          [&](ion_api::adnl_message_createChannel &msg) {
            message_ = adnlmessage::AdnlMessageCreateChannel{msg.key_, msg.date_};
          },
          [&](ion_api::adnl_message_confirmChannel &msg) {
            message_ = adnlmessage::AdnlMessageConfirmChannel{msg.key_, msg.peer_key_, msg.date_};
          },
          [&](ion_api::adnl_message_custom &msg) { message_ = adnlmessage::AdnlMessageCustom{std::move(msg.data_)}; },
          [&](ion_api::adnl_message_nop &msg) { message_ = adnlmessage::AdnlMessageNop{}; },
          [&](ion_api::adnl_message_reinit &msg) { message_ = adnlmessage::AdnlMessageReinit{msg.date_}; },
          [&](ion_api::adnl_message_query &msg) {
            message_ = adnlmessage::AdnlMessageQuery{msg.query_id_, std::move(msg.query_)};
          },
          [&](ion_api::adnl_message_answer &msg) {
            message_ = adnlmessage::AdnlMessageAnswer{msg.query_id_, std::move(msg.answer_)};
          },
          [&](ion_api::adnl_message_part &msg) {
