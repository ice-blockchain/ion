...
td::Status ValidatorEngine::load_global_config() {
  ...
  if (celldb_in_memory_ && celldb_v2_) {
    return td::Status::Error(ion::ErrorCode::error, "at most one of --celldb-in-memory --celldb-v2 could be used");
  }
...
void ValidatorEngine::start_full_node() {
  if (!config_.full_node.is_zero() || !config_.full_node_slaves.empty()) {
    ...
    ion::validator::fullnode::FullNodeOptions full_node_options{
...
void ValidatorEngine::register_fast_sync_certificate_callback() {
  class Callback : public ion::adnl::Adnl::Callback {
   public:
    ...
    void receive_message(ion::adnl::AdnlNodeIdShort src, ion::adnl::AdnlNodeIdShort dst,
                         td::BufferSlice data) override {
      auto R = ion::fetch_tl_object<ion::ton_api::tonNode_newFastSyncMemberCertificate>(
          std::move(data), true);
      if (R.is_error()) {
        return;
      }
...
void ValidatorEngine::run_control_query(ion::ton_api::engine_validator_addShard &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
...
void ValidatorEngine::run_control_query(ion::ton_api::engine_validator_delShard &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
...
void ValidatorEngine::run_control_query(ion::ton_api::engine_validator_addCollator &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
...
void ValidatorEngine::run_control_query(ion::ton_api::engine_validator_delCollator &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
