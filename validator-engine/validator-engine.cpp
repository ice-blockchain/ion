...
Config::Config(const ion::ion_api::engine_validator_config &config) {
  full_node = ion::PublicKeyHash::zero();
...
ion::tl_object_ptr<ion::ion_api::engine_validator_config> Config::tl() const {
  ...
  std::vector<ion::tl_object_ptr<ion::ion_api::tonNode_shardId>> shards_vec;
...
void ValidatorEngine::set_shard_check_function() {
  if (!not_all_shards_) {
    validator_options_.write().set_shard_check_function([](ion::ShardIdFull shard) -> bool { return true; });
  } else {
    ...
    validator_options_.write().set_shard_check_function(
        [shards = std::move(shards)](ion::ShardIdFull shard) -> bool {
          for (auto s : shards) {
...
void ValidatorEngine::run_control_query(ion::ion_api::engine_validator_exportAllPrivateKeys &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_unsafe)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
  ...
  td::actor::send_closure(
      ...
      [promise = std::move(promise),
       client_pubkey = std::move(client_pubkey)](td::Result<std::vector<ion::PrivateKey>> R) mutable {
        ...
        promise.set_value(ion::create_serialize_tl_object<ion::ion_api::engine_validator_exportedPrivateKeys>(
...
void ValidatorEngine::run_control_query(ion::ion_api::engine_validator_addShard &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
...
void ValidatorEngine::run_control_query(ion::ion_api::engine_validator_delShard &query,
                                        td::BufferSlice data, ion::PublicKeyHash src, td::uint32 perm,
                                        td::Promise<td::BufferSlice> promise) {
  if (!(perm & ValidatorEnginePermissions::vep_modify)) {
    promise.set_value(create_control_query_error(td::Status::Error(ion::ErrorCode::error, "not authorized")));
...
void ValidatorEngine::process_control_query(td::uint16 port, ion::adnl::AdnlNodeIdShort src,
  ...
  ion::ion_api::downcast_call(*f, [&](auto &obj) {
