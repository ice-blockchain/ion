...
class Collator final : public td::actor::Actor {
 public:
  ...
  static constexpr long long supported_capabilities() {
    return ion::capCreateStatsEnabled | ion::capBounceMsgBody | ion::capReportVersion | ion::capShortDequeue |
           ion::capStoreOutMsgQueueSize | ion::capMsgMetadata | ion::capDeferMessages | ion::capFullCollatedData;
  }
 ...
 private:
  ...
  ion::BlockId new_id{workchainInvalid, 0, 0};
  bool busy_{false};
 ...
 private:
  ...
  void after_get_aux_shard_state(ion::BlockIdExt blkid, td::Result<Ref<ShardState>> res, td::PerfLogAction token);
  ...
  bool precheck_inbound_message(Ref<vm::CellSlice> msg, ion::LogicalTime lt);
  bool process_inbound_message(Ref<vm::CellSlice> msg, ion::LogicalTime lt, td::ConstBitPtr key, int src_nb_idx);
