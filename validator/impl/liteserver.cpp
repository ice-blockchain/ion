      ...
      *query_obj_,
      td::overloaded(
          ...
          [&](lite_api::liteServer_lookupBlockWithProof& q) {
            this->perform_lookupBlockWithProof(ion::create_block_id_simple(q.id_), ion::create_block_id(q.mc_block_id_),
...
void LiteQuery::perform_getMasterchainInfo(int mode) {
  ...
  td::actor::send_closure_later(manager_, &ion::validator::ValidatorManager::get_last_liteserver_state_block,
                                [Self = actor_id(this), return_state = bool(acc_state_promise_),
                                 mode](td::Result<std::pair<Ref<ion::validator::MasterchainState>, BlockIdExt>> res) {
                                  if (res.is_error()) {
...
void LiteQuery::perform_getLibraries(std::vector<td::Bits256> library_list) {
  ...
  td::actor::send_closure_later(
      manager_, &ion::validator::ValidatorManager::get_last_liteserver_state_block,
      [Self = actor_id(this),
       library_list](td::Result<std::pair<Ref<ion::validator::MasterchainState>, BlockIdExt>> res) -> void {
        if (res.is_error()) {
          td::actor::send_closure(Self, &LiteQuery::abort_query, res.move_as_error());
        } else {
          auto pair = res.move_as_ok();
...
void LiteQuery::continue_getLibraries(Ref<ion::validator::MasterchainState> mc_state, BlockIdExt blkid,
...
void LiteQuery::continue_getLibrariesWithProof(std::vector<td::Bits256> library_list, int mode) {
  ...
  auto b = ion::create_serialize_tl_object<ion::lite_api::liteServer_libraryResultWithProof>(
      ion::create_tl_lite_block_id(base_blk_id_), mode, std::move(result), state_proof_boc.move_as_ok(),
...
void LiteQuery::finish_getTransactions() {
  ...
  std::vector<ion::tl_object_ptr<ion::lite_api::tonNode_blockIdExt>> a;
...
void LiteQuery::continue_lookupBlockWithProof_getHeaderProof(Ref<ion::validator::BlockData> block,
...
void LiteQuery::continue_lookupBlockWithProof_getMcBlockPrev(
  ...
  auto b = ion::create_serialize_tl_object<ion::lite_api::liteServer_lookupBlockResult>(
      ion::create_tl_lite_block_id(blk_id_), mode_, ion::create_tl_lite_block_id(base_blk_id_alt_),
