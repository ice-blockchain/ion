...
class ShardConfig {
 ...
 public:
  ...
  std::vector<ion::BlockIdExt> get_shard_hash_ids_ext(bool skip_mc = false) const;
  std::vector<ion::BlockId> get_shard_hash_ids(const std::function<bool(ion::ShardIdFull, bool)>& filter) const;
  std::vector<ion::BlockIdExt> get_shard_hash_ids_ext(const std::function<bool(ion::ShardIdFull, bool)>& filter) const;
