...
set(ZLIB_SOURCE_DIR ${ION_THIRD_PARTY_SOURCE_DIR}/zlib)
set(ZLIB_BINARY_DIR ${ION_THIRD_PARTY_BINARY_DIR}/zlib)
...
if (ANDROID)
  set(ZLIB_BINARY_DIR ${ION_ANDROID_THIRD_PARTY_DIR}/zlib/${ION_ANDROID_ARCH_DIR})
  ...
  add_custom_command(
      ...
      COMMAND ${CMAKE_COMMAND} -E env
        ...
        CFLAGS=${ZLIB_CFLAGS}
        make install
      COMMAND ${ION_ANDROID_RANLIB} ${ZLIB_LIBRARY}
