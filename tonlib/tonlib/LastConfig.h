...
class LastConfig : public td::actor::Actor {
 ...
 private:
  ...
  void on_config(td::Result<ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo>> r_config);
  td::Status process_config(td::Result<ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo>> r_config);
  td::Status process_config_proof(ion::ton_api::object_ptr<ion::lite_api::liteServer_configInfo> config);
