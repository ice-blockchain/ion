...
bool parse_std_addr_q(CellSlice cs, ion::WorkchainId& res_wc, ion::StdSmcAddress& res_addr, int global_version,
                      bool quiet) {
...
std::pair<ion::WorkchainId, ion::StdSmcAddress> parse_std_addr(CellSlice cs, int global_version) {
