...
int main() {
  ...
  auto decode_encode = [](auto obj_json) {
    ...
    ion::ton_api::object_ptr<ion::ton_api::Object> obj2;
  ...
  td::Bits256 uint256;
  uint256.set_ones();
  test_tl_json(ion::ton_api::make_object<ion::ton_api::adnl_id_short>(uint256));

  test_tl_json(ion::ton_api::make_object<ion::ton_api::testObject>(
      1, ion::ton_api::make_object<ion::ton_api::adnl_id_short>(uint256),
      ion::ton_api::make_object<ion::ton_api::getTestObject>()));
  ...
  auto decode_encode_local = [](auto obj_json) {
    auto as_json_value = td::json_decode(obj_json).move_as_ok();
    ion::ton_api::config_local config_local;
  ...
  test_tl_json(ion::ton_api::make_object<ion::ton_api::testVectorBytes>(create_vector_bytes()));
