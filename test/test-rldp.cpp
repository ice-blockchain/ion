...
int main() {
  ...
  td::actor::ActorOwn<ion::rldp::Rldp> rldp;
  ...
  scheduler.run_in_context([&] {
    ...
    rldp = ion::rldp::Rldp::create(adnl.get());
    ...
    td::actor::send_closure(adnl, &ion::adnl::Adnl::add_id, ion::adnl::AdnlNodeIdFull{pub2}, addr,
                            static_cast<td::uint8>(0));
    td::actor::send_closure(rldp, &ion::rldp::Rldp::add_id, src);
    td::actor::send_closure(rldp, &ion::rldp::Rldp::add_id, dst);
  ...
  for (auto &size : sizes) {
    ...
    scheduler.run_in_context([&] {
      remaining++;
      td::actor::send_closure(rldp, &ion::rldp::Rldp::send_query_ex, src, dst, std::string("t"),
