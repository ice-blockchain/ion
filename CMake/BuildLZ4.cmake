...
set(LZ4_SOURCE_DIR ${ION_THIRD_PARTY_SOURCE_DIR}/lz4)
set(LZ4_BINARY_DIR ${ION_THIRD_PARTY_BINARY_DIR}/lz4)
...
elseif (ANDROID)
  set(LZ4_BINARY_DIR ${ION_ANDROID_THIRD_PARTY_DIR}/lz4/${ION_ANDROID_ARCH_DIR})
  set(LZ4_BUILD_DIR ${LZ4_BINARY_DIR}/cmake)
  set(LZ4_INCLUDE_DIRS ${ION_ANDROID_THIRD_PARTY_DIR}/lz4/include)
  set(LZ4_LIBRARY ${LZ4_BINARY_DIR}/lib/liblz4.a)
  set(LZ4_ARCH_STAMP ${LZ4_BINARY_DIR}/.android_arch)
  set(LZ4_ARCH_EXPECTED "${ION_ANDROID_ABI};${ION_ANDROID_API};${ION_ANDROID_CC}")
  ...
  if (ION_ANDROID_ABI)
    list(APPEND LZ4_ANDROID_CMAKE_ARGS -DANDROID_ABI=${ION_ANDROID_ABI})
  endif()
  if (ANDROID_PLATFORM)
