...
td::Status ExportAllPrivateKeysQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_exportAllPrivateKeys>(
...
td::Status ExportAllPrivateKeysQuery::receive(td::BufferSlice data) {
  TRY_RESULT_PREFIX(f, ion::fetch_tl_object<ion::ion_api::engine_validator_exportedPrivateKeys>(data.as_slice(), true),
                    "received incorrect answer: ");
...
td::Status SignShardOverlayCertificateQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_signShardOverlayCertificate>(
      shard_.workchain, shard_.shard, ion::create_tl_object<ion::ion_api::engine_validator_keyHash>(key_.tl()),
...
td::Status AddShardQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_addShard>(ion::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
...
td::Status DelShardQuery::send() {
  auto b = ion::create_serialize_tl_object<ion::ion_api::engine_validator_delShard>(ion::create_tl_shard_id(shard_));
  td::actor::send_closure(console_, &ValidatorEngineConsole::envelope_send_query, std::move(b), create_promise());
  return td::Status::OK();
}
