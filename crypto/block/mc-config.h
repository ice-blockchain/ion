...
struct StoragePrices {
  ...
  static td::RefInt256 compute_storage_fees(ion::UnixTime now, const std::vector<block::StoragePrices>& pricing,
                                            const StorageUsed& storage_used, ion::UnixTime last_paid, bool is_special,
                                            bool is_masterchain);
};
...
class Config {
 ...
 public:
  ...
  td::optional<ion::NewConsensusConfig> get_new_consensus_config(ion::WorkchainId wc) const;
  ...
  std::vector<ion::ValidatorDescr> compute_validator_set(ion::ShardIdFull shard, const block::TotalValidatorSet& vset,
...
class ConfigInfo : public Config, public ShardConfig {
 ...
 public:
  ...
  std::vector<ion::ValidatorDescr> compute_validator_set_cc(ion::ShardIdFull shard,
  ...
  static td::Result<std::unique_ptr<ConfigInfo>> extract_config(Ref<vm::Cell> mc_state_root,
                                                                ion::BlockIdExt mc_block_id, int mode = 0);
