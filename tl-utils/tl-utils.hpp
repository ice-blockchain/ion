...
template <class Tp, std::enable_if_t<std::is_base_of<ion_api::Object, Tp>::value>>
td::UInt256 get_tl_object_sha256(const Tp &T) {
  return get_tl_object_sha256(static_cast<const ion_api::Object *>(&T));
}
...
td::Bits256 get_tl_object_sha_bits256(const Tp &T) {
  return get_tl_object_sha_bits256(static_cast<const ion_api::Object *>(&T));
}
}  // namespace ion
