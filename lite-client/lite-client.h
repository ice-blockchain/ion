...
class TestNode : public td::actor::Actor {
 private:
  ...
  void get_msg_queue_sizes_cont(ion::BlockIdExt mc_blkid, td::BufferSlice data);
  void get_msg_queue_sizes_finish(std::vector<ion::BlockIdExt> blocks, std::vector<td::uint64> sizes);
