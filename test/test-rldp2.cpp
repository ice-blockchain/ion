...
int main() {
  ...
  td::actor::ActorOwn<ion::rldp2::Rldp> rldp;
  ...
  scheduler.run_in_context([&] {
    ...
    rldp = ion::rldp2::Rldp::create(adnl.get());
    ...
    td::actor::send_closure(rldp, &ion::rldp2::Rldp::add_id, src);
    td::actor::send_closure(rldp, &ion::rldp2::Rldp::add_id, dst);
  ...
  for (auto &size : sizes) {
    ...
    scheduler.run_in_context([&] {
      remaining++;
      td::actor::send_closure(rldp, &ion::rldp2::Rldp::send_query_ex, src, dst, std::string("t"),
  ...
  scheduler.run_in_context([&] {
    td::actor::send_closure(network_manager, &ion::adnl::TestLoopbackNetworkManager::set_loss_probability, 0.1);
  });
