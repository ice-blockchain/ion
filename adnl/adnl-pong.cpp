...
int main(int argc, char *argv[]) {
  ...
  scheduler.run_in_context([&]() {
    ...
    auto tladdr = ion::create_tl_object<ion::ton_api::adnl_address_udp>(addr.get_ipv4(), addr.get_port());
    auto addr_vec = std::vector<ion::tl_object_ptr<ion::ton_api::adnl_Address>>();
    addr_vec.push_back(std::move(tladdr));
    auto tladdrlist = ion::create_tl_object<ion::ton_api::adnl_addressList>(
    ...
    td::actor::send_closure(adnl, &ion::adnl::Adnl::subscribe, ion::adnl::AdnlNodeIdShort{pub.compute_short_id()},
                            ion::adnl::Adnl::int_to_bytestring(ion::ton_api::adnl_ping::ID),
