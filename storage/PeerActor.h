...
class PeerActor : public td::actor::Actor {
 ...
 private:
  ...
  td::BufferSlice create_update_query(ion::tl_object_ptr<ion::ton_api::storage_Update> update);
  ...
  void execute_add_update(ion::ton_api::storage_addUpdate &add_update, td::Promise<td::BufferSlice> promise);
  void execute_get_piece(ion::ton_api::storage_getPiece &get_piece, td::Promise<td::BufferSlice> promise);
