...
td::BufferSlice create_error_response(const std::string &proto_version, int code, const std::string &reason) {
  return ion::create_serialize_tl_object<ion::ton_api::http_response>(
      proto_version, code, reason, std::vector<ion::tl_object_ptr<ion::ton_api::http_header>>(), true);
}
...
class HttpRldpPayloadReceiver : public td::actor::Actor {
 public:
  ...
  void request_more_data() {
    ...
    auto f = ion::create_serialize_tl_object<ion::ton_api::http_getNextPayloadPart>(
  ...
  void add_data(td::BufferSlice data) {
    ...
    auto F = ion::fetch_tl_object<ion::ton_api::http_payloadPart>(data, true);
    if (F.is_error()) {
...
class HttpRldpPayloadSender : public td::actor::Actor {
 public:
  ...
  std::string generate_prefix() const {
    ...
    auto id = ion::ton_api::http_getNextPayloadPart::ID;
  ...
  void send_data(ion::tl_object_ptr<ion::ton_api::http_getNextPayloadPart> query,
  ...
  void receive_query(ion::tl_object_ptr<ion::ton_api::http_getNextPayloadPart> f,
                     td::Promise<td::BufferSlice> promise) {
...
class TcpToRldpRequestSender : public td::actor::Actor {
 public:
  ...
  void got_result(td::BufferSlice data) {
    auto F = ion::fetch_tl_object<ion::ton_api::http_response>(data, true);
    if (F.is_error()) {
      abort_query(F.move_as_error());
      return;
    }
 ...
 protected:
  ...
  ion::tl_object_ptr<ion::ton_api::http_request> request_tl_;
...
class RldpTcpTunnel : public td::actor::Actor, private td::ObserverBase {
 public:
  ...
  void request_data() {
    ...
    auto f = ion::create_serialize_tl_object<ion::ton_api::http_getNextPayloadPart>(id_, out_seqno_++,
                                                                                    (1 << 21) - (1 << 11));
    td::actor::send_closure(rldp_, &ion::adnl::AdnlSenderInterface::send_query_ex, local_id_, src_, "payload part",
  ...
  void answer_query(bool allow_empty = false, bool from_timer = false) {
    ...
    if (cur_promise_ && (!input.empty() || close_ || allow_empty)) {
      ...
      cur_promise_.set_result(ion::create_serialize_tl_object<ion::ton_api::http_payloadPart>(
          std::move(data), std::vector<ion::tl_object_ptr<ion::ton_api::http_header>>(), close_));
      ++cur_seqno_;
      cur_promise_.reset();
...
class RldpHttpProxy : public td::actor::Actor {
 public:
  ...
  void run_cont() {
    ...
    }
    {
      ...
      if (!is_client_) {
        ion::adnl::AdnlAddress x = ion::adnl::AdnlAddressImpl::create(
            ion::create_tl_object<ion::ton_api::adnl_address_udp>(addr_.get_ipv4(), addr_.get_port()));
    ...
    class AdnlCapabilitiesCb : public ion::adnl::Adnl::Callback {
     public:
      ...
      void receive_query(ion::adnl::AdnlNodeIdShort src, ion::adnl::AdnlNodeIdShort dst, td::BufferSlice data,
                         td::Promise<td::BufferSlice> promise) override {
        TRY_RESULT_PROMISE(promise, query, ion::fetch_tl_object<ion::ton_api::http_proxy_getCapabilities>(data, true));
        promise.set_result(ion::create_serialize_tl_object<ion::ton_api::http_proxy_capabilities>(CAPABILITIES));
    ...
    for (auto &serv_id : server_ids_) {
      td::actor::send_closure(adnl_, &ion::adnl::Adnl::subscribe, serv_id,
                              ion::adnl::Adnl::int_to_bytestring(ion::ton_api::http_request::ID),
                              std::make_unique<AdnlServerCb>(actor_id(this)));
      if (local_id_ != serv_id) {
        td::actor::send_closure(adnl_, &ion::adnl::Adnl::subscribe, serv_id,
                                ion::adnl::Adnl::int_to_bytestring(ion::ton_api::http_getNextPayloadPart::ID),
                                std::make_unique<AdnlPayloadCb>(actor_id(this)));
        td::actor::send_closure(adnl_, &ion::adnl::Adnl::subscribe, serv_id,
                                ion::adnl::Adnl::int_to_bytestring(ion::ton_api::http_proxy_getCapabilities::ID),
  ...
  void receive_rldp_request(ion::adnl::AdnlNodeIdShort src, ion::adnl::AdnlNodeIdShort dst, td::BufferSlice data,
    ...
    TRY_RESULT_PROMISE(promise, f, ion::fetch_tl_object<ion::ton_api::http_request>(data, true));
  ...
  void start_tcp_tunnel(td::Bits256 id, ion::adnl::AdnlNodeIdShort src, ion::adnl::AdnlNodeIdShort local_id,
    ...
    td::actor::create_actor<RldpTcpTunnel>(td::actor::ActorOptions().with_name("tunnel").with_poll(), id, src, local_id,
        ...
        .release();
    std::vector<ion::tl_object_ptr<ion::ton_api::http_header>> headers;
    headers.push_back(
        ion::create_tl_object<ion::ton_api::http_header>(PROXY_SITE_VERISON_HEADER_NAME, PROXY_VERSION_HEADER));
    promise.set_result(ion::create_serialize_tl_object<ion::ton_api::http_response>(
  ...
  void receive_payload_part_request(td::BufferSlice data, td::Promise<td::BufferSlice> promise) {
    auto F = ion::fetch_tl_object<ion::ton_api::http_getNextPayloadPart>(data, true);
    if (F.is_error()) {
  ...
  void register_payload_sender(
      td::Bits256 id,
      std::function<void(ion::tl_object_ptr<ion::ton_api::http_getNextPayloadPart>, td::Promise<td::BufferSlice>)> f,
      ...
      auto send_query = [&, this, SelfId = actor_id(this)](const ion::adnl::AdnlNodeIdShort &local_id) {
        td::actor::send_closure(
            ...
            [SelfId, peer](td::Result<td::BufferSlice> R) {
              ...
              auto r_obj = ion::fetch_tl_object<ion::ton_api::http_proxy_capabilities>(R.move_as_ok(), true);
              if (r_obj.is_error()) {
                return;
              }
            ...
            td::Timestamp::in(3.0),
            ion::create_serialize_tl_object<ion::ton_api::http_proxy_getCapabilities>(CAPABILITIES));
      };
 ...
 private:
  ...
  std::map<td::Bits256,
           std::function<void(ion::tl_object_ptr<ion::ton_api::http_getNextPayloadPart>, td::Promise<td::BufferSlice>)>>
      payload_senders_;
...
void HttpRldpPayloadSender::start_up() {
  td::actor::send_closure(
      ...
      [SelfId = actor_id(this)](ion::tl_object_ptr<ion::ton_api::http_getNextPayloadPart> f,
                                td::Promise<td::BufferSlice> promise) {
